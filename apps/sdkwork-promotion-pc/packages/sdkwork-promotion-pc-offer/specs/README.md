...
This directory is the local standards index for `@sdkwork/promotion-pc-offer`.
...
| Field | Value |
| --- | --- |
| Name | `@sdkwork/promotion-pc-offer` |
| Type | `react-package` |
| Root | `sdkwork-promotion/apps/sdkwork-promotion-pc/packages/sdkwork-promotion-pc-offer` |
| Domain | `commerce` |
| Capability | `offer` |
