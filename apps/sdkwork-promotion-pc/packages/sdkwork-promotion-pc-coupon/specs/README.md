...
This directory is the local standards index for `@sdkwork/promotion-pc-coupon`.
...
| Field | Value |
| --- | --- |
| Name | `@sdkwork/promotion-pc-coupon` |
| Type | `react-package` |
| Root | `sdkwork-promotion/apps/sdkwork-promotion-pc/packages/sdkwork-promotion-pc-coupon` |
| Domain | `commerce` |
| Capability | `coupon` |
...
- `pnpm --filter @sdkwork/promotion-pc-coupon typecheck`
