...
This directory is the local standards index for `@sdkwork/promotion-pc-pricing`.
...
| Field | Value |
| --- | --- |
| Name | `@sdkwork/promotion-pc-pricing` |
| Type | `react-package` |
| Root | `sdkwork-promotion/apps/sdkwork-promotion-pc/packages/sdkwork-promotion-pc-pricing` |
| Domain | `commerce` |
| Capability | `pricing` |
...
- `pnpm --filter @sdkwork/promotion-pc-pricing typecheck`
